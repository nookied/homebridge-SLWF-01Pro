...
class DeviceAccessory {
	...
	warnIfCustomFanModeIgnored() {
		...
		this.log.warn(
			...
			'The fan slider will settle on what the device reports.'
		);
	}
	...
	warnIfPresetIgnored() {
		...
		this.log.warn(
			...
			'This is a long-standing bug in ESPHome\'s midea component (esphome/issues#3880, open since 2022), not something ' +
			'a firmware update fixes. Set "disablePresets": true to hide these switches.'
		);
	}
